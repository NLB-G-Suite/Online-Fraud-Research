...
# chanVideos=json.load(open('domainChannelsVids.json'))
...
# with open('classifyChan.json', 'w') as fp:
#     json.dump(chanVideos, fp)

clasChan=json.load(open('classifyChan.json'))
...
# 	f.write(t)
with open('fraudChannels.json', 'w') as fp:
